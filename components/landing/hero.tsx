...
export function Hero() {
  return (
    ...
    >
      ...
      <div className="mx-auto grid min-h-[calc(100svh-4rem)] w-full max-w-7xl items-center gap-10 px-4 py-10 sm:px-6 md:py-14 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:py-16">
        <motion.div
        ...
        >
          ...
          <h1 className="max-w-4xl font-heading text-[clamp(3rem,16vw,4.45rem)] leading-[0.96] text-[#2F2433] sm:text-6xl lg:text-7xl">
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
            <Button
              asChild
              className="h-13 rounded-full bg-[#A7353F] px-7 text-base text-[#FFFDFB] shadow-lg shadow-[#A7353F]/20 hover:bg-[#8E2D36] focus-visible:ring-[#DFA2BA]/50"
            >
              <Link href="/#citas">
                Reservar cita
            ...
            <Button
              asChild
              variant="outline"
              className="h-13 rounded-full border-[#E8D6DE] bg-white/75 px-7 text-base text-[#5B3A63] hover:bg-[#FFF6F8] focus-visible:ring-[#DFA2BA]/50"
            >
              <Link href="/#adopciones">Conocer adopciones</Link>
            </Button>
          </div>
          <div className="mt-9 grid max-w-xl grid-cols-1 gap-3 min-[430px]:grid-cols-3">
            {[
              ...
              <div
                key={label}
                className="rounded-3xl border border-[#E8D6DE] bg-white/72 p-4 text-center shadow-sm backdrop-blur"
              >
